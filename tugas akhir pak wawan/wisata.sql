...
INSERT INTO `tiket` (`id`, `order_id`, `nama_pelanggan`, `wisata`, `jumlah`, `total_harga`, `status`, `tanggal_pesan`) VALUES
(5, 'ORD1747773643', 'ahmad', 'Taman Way Kambas', 1, 30000, 'Sudah bayar', '2025-05-20 20:43:19'),
(6, 'ORD1747773820', 'habibi', 'Lembah Hijau', 1, 30000, 'Sudah bayar', '2025-05-20 20:43:48'),
(7, 'ORD1747773952', 'hab', 'tegal mas', 1, 50000, 'Sudah bayar', '2025-05-20 20:46:01'),
(8, 'ORD1747892620', 'al', 'Bukit Aslan', 1, 30000, 'Sudah bayar', '2025-05-22 05:48:49'),
(9, 'ORD1747893582', 'el ', 'Bukit Aslan', 12, 360000, 'Sudah bayar', '2025-05-22 06:00:00'),
(10, 'ORD1747906144', 'eko', 'Slanik Waterpark', 1, 50000, 'Sudah bayar', '2025-05-22 09:29:16');
...
(1, 'admin', '123', 'admin'),
(6, 'user', '$2y$10$D7F2DYyC/qIOrXstGPU4z.mwteju0e5oxG4Gxpod/MMjDrO4w1TQa', 'user'),
(9, 'habibi', '123', 'admin'),
(11, 'hanip', '$2y$10$gTzbb5i8aIk9ByCCvHt4Ee7Z2aZKjHEq1qlM4dqXs8yE2ZRKej0R.', 'user');
